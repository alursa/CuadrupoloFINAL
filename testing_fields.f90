...
protonmovil%vel = vector(0.0_d,0.0_d,0.0_d)
...
sim%N_step = 50000 !!AQUÍ EL LIMITE ES CUANDO EL PROGRAMA HACE KAPUTT
sim%ttot = 1E-16_d !!En este ejemplo se realizará la
